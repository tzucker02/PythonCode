...
- [Python Functions Windows installer (MSI) - link to new google drive file that includes python source code](https://drive.google.com/uc?export=download&id=1Dbufbj7jemkEuE840bXeb4jNOCrYWoGW).
