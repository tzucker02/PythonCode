...
- [File of all functions I used for several OMDS courses](https://github.com/tzucker02/PythonCode/blob/main/omds.py) - NOTE that this file can be easily imported by using the file [usage]  
### Compressed files
