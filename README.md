...
- [Python Functions Windows installer (MSI) - link to new google drive file that includes python source code](https://drive.google.com/uc?export=download&id=1PC3WKEShzsMj6HKTFMH4-P57BD1KOrQz).
